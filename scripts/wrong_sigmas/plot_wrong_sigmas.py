# -*- coding: utf-8 -*-
"""
Created on Fri Nov 25 23:51:13 2022
...
fig.text(0.84, .815, r'$\tau = 200$ d$t$', ha='center',fontsize=16,color='#7b7978')
fig.text(0.84, .15, r'$\tau = 280$ d$t$', ha='center',fontsize=16,color='#7b7978')

fig.text(0.41, .815, r'$\tau = 160$ d$t$', ha='center',fontsize=16,color='#7b7978')
fig.text(0.41, .15, r'$\tau = 240$ d$t$', ha='center',fontsize=16,color='#7b7978')
...
# #%%
pal1 = sns.cubehelix_palette(as_cmap=True)
mn = np.nanmean(wRMSES_init[0,ob1, :], axis=-1)
stt = np.nanstd(wRMSES_init[0,ob1, :], axis=-1)
...
mn = np.nanmean(wRMSES1[0,ob1, :], axis=-1)
stt = np.nanstd(wRMSES1[0,ob1, :], axis=-1)
...
mn = np.nanmean(wRMSES2[0,ob1, :], axis=-1)
stt = np.nanstd(wRMSES2[0,ob1, :], axis=-1)
...
mn = np.nanmean(wRMSES_init[1,ob1, :], axis=-1)
stt = np.nanstd(wRMSES_init[1,ob1, :], axis=-1)
plt.plot( gss[:], np.nanmean(wRMSES_init[1,ob1, :], axis=-1),'o',linestyle='--', label='gaus',lw=3, c=pal2(0.1))
plt.plot( np.array([gss,gss]), np.array([mn+stt, mn-stt]),linestyle='-', lw=3, c=pal2(0.1), solid_capstyle='round')

mn = np.nanmean(wRMSES1[1,ob1, :], axis=-1)
stt = np.nanstd(wRMSES1[1,ob1, :], axis=-1)
plt.plot( gss[:], np.nanmean(wRMSES1[1,ob1, :], axis=-1),'v',linestyle='-.',label='1st',lw=3, c=pal2(0.4))
plt.plot( np.array([gss,gss]), np.array([mn+stt, mn-stt]),linestyle='-', lw=3, c=pal2(0.4), solid_capstyle='round')

mn = np.nanmean(wRMSES2[1,ob1, :], axis=-1)
stt = np.nanstd(wRMSES2[1,ob1, :], axis=-1)
plt.plot( gss[:], np.nanmean(wRMSES2[1,ob1, :], axis=-1), 's', linestyle='-',label='2nd',lw=3, c=pal2(0.8))
plt.plot( np.array([gss,gss]), np.array([mn+stt, mn-stt]),linestyle='-', lw=3, c=pal2(0.8), solid_capstyle='round')
plt.xlabel(r'noise amplitude $\hat{\sigma}$', fontsize=20)
# plt.xticks(gss)
...
##%%
plt.vlines(0.5, 0.5, 2,linestyle=':', color='#900C3F',lw=2.5, zorder=0)
plt.ylim(0.6,1.8)
...
mn = np.nanmean(wRMSES_init[1,ob1, :], axis=-1)
stt = np.nanstd(wRMSES_init[1,ob1, :], axis=-1)
plt.plot( gss[:], np.nanmean(wRMSES_init[1,ob1, :], axis=-1),'o',linestyle='--',lw=3, c=pal2(0.1))
plt.plot( np.array([gss,gss]), np.array([mn+stt, mn-stt]),linestyle='-', lw=3, c=pal2(0.1), solid_capstyle='round')

mn = np.nanmean(wRMSES1[1,ob1, :], axis=-1)
stt = np.nanstd(wRMSES1[1,ob1, :], axis=-1)
plt.plot( gss[:], np.nanmean(wRMSES1[1,ob1, :], axis=-1),'v',linestyle='-.',lw=3, c=pal2(0.4))
plt.plot( np.array([gss,gss]), np.array([mn+stt, mn-stt]),linestyle='-', lw=3, c=pal2(0.4), solid_capstyle='round')

mn = np.nanmean(wRMSES2[1,ob1, :], axis=-1)
stt = np.nanstd(wRMSES2[1,ob1, :], axis=-1)
plt.plot( gss[:], np.nanmean(wRMSES2[1,ob1, :], axis=-1), 's', linestyle='-',lw=3, c=pal2(0.8))
plt.plot( np.array([gss,gss]), np.array([mn+stt, mn-stt]),linestyle='-', lw=3, c=pal2(0.8), solid_capstyle='round')
plt.ylim(None,2.)
plt.vlines(0.5, 0.5, 2,linestyle=':', color='#900C3F',lw=2.5, zorder=0)
#plt.xticks(gss)
...
plt.ylabel('wRMSE', fontsize=20)
leg = plt.legend(frameon = 0, bbox_transform=fig.transFigure,
           bbox_to_anchor=(1.010, 0.845), fontsize='x-large', ncol=1, handlelength=0.35)
leg.set_title('T: 500', prop = {'size':18})
##%%
...
plt.vlines(0.5, 0., 2,linestyle=':', color='#900C3F',lw=2.5, zorder=0)   
# plt.plot( Ts, np.mean(RMSES_init[:,1, 0], axis=-1), label='init-0.25')
# plt.plot( Ts, np.mean(RMSES_init[:,1, 1], axis=-1), label='init-0.50')
# plt.plot( Ts, np.mean(RMSES_init[:,1, 2], axis=-1), label='init-0.75')
ob1 = 1
...
mn = np.nanmean(wRMSES_init[0,ob1, :], axis=-1)
stt = np.nanstd(wRMSES_init[0,ob1, :], axis=-1)
plt.plot( gss[:], mn,'o',linestyle='--', lw=3, c=pal1(0.1))
plt.plot( np.array([gss,gss]), np.array([mn+stt, mn-stt]),linestyle='-', lw=3, c=pal1(0.1), solid_capstyle='round')

mn = np.nanmean(wRMSES1[0,ob1, :], axis=-1)
stt = np.nanstd(wRMSES1[0,ob1, :], axis=-1)
plt.plot( gss[:], mn,'v',linestyle='-.', lw=3, c=pal1(0.4))
plt.plot( np.array([gss,gss]), np.array([mn+stt, mn-stt]),linestyle='-', lw=3, c=pal1(0.4), solid_capstyle='round')

mn = np.nanmean(wRMSES2[0,ob1, :], axis=-1)
stt = np.nanstd(wRMSES2[0,ob1, :], axis=-1)
plt.plot( gss[:], mn,'s', linestyle='-', lw=3, c=pal1(0.8))
plt.plot( np.array([gss,gss]), np.array([mn+stt, mn-stt]),linestyle='-', lw=3, c=pal1(0.8), solid_capstyle='round')
...
leg = plt.legend(frameon = 0, bbox_transform=fig.transFigure,
            bbox_to_anchor=(1.01, 0.435), fontsize='x-large', ncol=1, handlelength=0.35)
leg.set_title('T: 1000', prop = {'size':18})
##%%
...
plt.savefig(save_folder+'wrong_sigmas.png', bbox_inches='tight', facecolor=fig.get_facecolor(), edgecolor='none')
plt.savefig(save_folder+'wrong_sigmas.pdf', bbox_inches='tight', facecolor=fig.get_facecolor(), edgecolor='none')
plt.close()
